...
Άρα μπορείς να κρύψεις κάτι στην οθόνη και παρ’ όλα αυτά να στείλεις κατά λάθος το υποκείμενο κείμενο, OCR ή αντικείμενα που έμειναν. Αυτό είναι που λέμε **αναποτελεσματικό redaction**. Τίποτα «μαγικό», απλώς μια διαδικασία που μπερδεύει το «καλυμμένο» με το «αφαιρεμένο».
...
4) **Παράγω την έκδοση έτοιμη για αποστολή** (συνήθως scan-style, συνεπής, τελική)
