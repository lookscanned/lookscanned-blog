...
# 黑条不等于脱敏（是的，“爱泼斯坦文件”PDF 争论又提醒了所有人）
...
所以你可以把屏幕上的内容遮住，却仍然把底层文本、OCR 或遗留对象一起发出去。这就是大家说的 **无效脱敏（ineffective redaction）**。不是什么高深攻击，通常只是工作流把“遮住”当成了“删除”。
...
- 如果文档要外发，再看一眼 **元数据**（author/title/subject）
