...
El tema Hugo PaperMod incluye por defecto un selector de idiomas que muestra todos los idiomas disponibles en línea horizontal en la cabecera. Esta solución es adecuada para sitios con pocos idiomas, pero para proyectos como Look Scanned, que soporta más de 20 idiomas, la cabecera se vuelve demasiado saturada. Para solucionar este problema, hemos desarrollado una versión más elegante utilizando un menú desplegable.

![Selector de idiomas original del tema PaperMod](./old-language-select.webp)

## Proceso de implementación

### Revisión del código base

El selector de idiomas se encuentra en el archivo `themes/PaperMod/layouts/partials/header.html`. Para personalizarlo, crearemos nuestra propia versión en `layouts/partials/header.html`. Este es el código base:
...
En nuestra nueva versión, utilizamos un icono de idioma de la biblioteca ionicons5 que funciona como botón y muestra todos los idiomas disponibles en un menú desplegable al pasar el cursor por encima. Aquí está el código detallado:
...
Para conseguir una experiencia de usuario fluida y atractiva, aplicamos estos estilos CSS:
...
Así se ve el resultado final. Al pasar el cursor sobre el icono de idioma, se despliega un elegante menú con la lista de idiomas disponibles:

![Nuevo selector de idiomas desplegable](./custom-language-select.webp)

Puedes encontrar el código completo en este [repositorio de GitHub](https://github.com/lookscanned/lookscanned-blog/commit/a47f5c2be887ab3ae198d1967f328d3683504ff0).

## Referencias

- [Documentación oficial del tema PaperMod](https://adityatelange.github.io/hugo-PaperMod/posts/papermod/papermod-faq/#bundling-custom-css-with-themes-assets)
