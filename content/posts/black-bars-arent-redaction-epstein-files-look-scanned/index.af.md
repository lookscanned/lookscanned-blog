...
keywords:
  - "Epstein files"
  - "PDF redaksie"
  - "oneffektiewe redaksie"
  - "PDF swart balke"
  - "laat PDF geskandeer lyk"
  - "Look Scanned"
---
...
- annotasies (highlights, shapes, comments)
- metadata (author/title/subject, ens.)
...
As jou proses is "teken 'n swart reghoek in Word/PowerPoint en export na PDF", speel jy met vuur. Dit kan reg wees. Of nie. En jy sal nie weet totdat jy die *werklike finale lêer* kontroleer wat jy stuur nie.

## Die vinnige kontroles wat ek doen voor ek 'n "geredigeerde" PDF stuur

Dis nie 'n volledige compliance-program nie. Dis 'n eenvoudige 60-90 sekonde roetine wat dom foute vang.

Ek kontroleer net die **finale uitgevoerde lêer** (die een wat regtig uitgestuur gaan word):

- **Search** vir sensitiewe terme (name, ID's, e-pos-fragmente, adresse)
- Probeer rondom die swart area selekteer en **copy/paste** in 'n plain text editor
- Maak dit in **twee verskillende viewers** oop (desktop app + browser is gewoonlik genoeg)
- Soek vir oorblywende **annotations/comments** (highlights, notes, shapes)
- Kyk na **metadata** (author/title/subject) as die dokument uitgaan
...
1) **Doen regte redaksie** (inhoud verwyder, nie net overlay nie)  
2) **Maak die ekstras skoon** (annotasies, aanhangsels, versteekte lae, metadata)  
3) **Verifieer die finale export** (met die kontrolelys hierbo)  
4) **Genereer die "stuurbare" weergawe** (gewoonlik scan-style, konsekwent, finaal)
...
Sodra die dokument behoorlik geredigeer is en ek die finale export geverifieer het, help Look Scanned my om 'n skoon **scan-style PDF** te maak - die tipe lêer wat mense by formele indienings verwag.
...
- skoner output met minder kans op random markup-lae (afhangend van jou export pipeline)

Die volgorde is die punt: **remove → verify → finalize**.
...
Behandel redaksie as 'n data-operasie, verifieer die presiese lêer wat jy gaan publiseer, en dink eers daarna oor die finale scan-voorkoms.
