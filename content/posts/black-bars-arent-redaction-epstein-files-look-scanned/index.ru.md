...
- **Поиск** по чувствительным словам (имена, ID, фрагменты email, адреса)
- Выделение вокруг черной области и **копировать/вставить** в обычный текстовый редактор
- Открытие в **двух разных программах просмотра** (desktop + браузер обычно достаточно)
- Проверка, не остались ли **аннотации/комментарии** (highlights, notes, shapes)
