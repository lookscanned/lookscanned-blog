...
1) **Che dữ liệu đúng cách** (xóa dữ liệu, không phải phủ đè)  
2) **Dọn phần dư thừa** (ghi chú, tệp đính kèm, lớp ẩn, siêu dữ liệu)  
3) **Xác minh bản xuất cuối** (theo danh sách kiểm tra ở trên)  
