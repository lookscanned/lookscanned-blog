...
1) **Doen regte redaksie** (inhoud verwyder, nie net oordekking nie)  
2) **Maak die ekstras skoon** (annotasies, aanhangsels, versteekte lae, metadata)  
3) **Verifieer die finale uitvoer** (met die kontrolelys hierbo)  
4) **Genereer die "stuurbare" weergawe** (gewoonlik in skandeerstyl, konsekwent, finaal)
